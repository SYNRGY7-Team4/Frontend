...
export default function Verification_E_KTP() {
  ...
  const { register, handleSubmit, formState: { errors } } = useForm<eKTPInput>({
            ...
            >
              <div className='flex flex-col gap-y-3'>
                <div className='flex flex-col gap-y-1'>
                  ...
                  />
                  <span className="text-sm">Max berukuran 1MB dengan format .jpg, .png</span>
                  <div
                    role='img'
              ...
              <div className='flex flex-col gap-y-2 items-center'>
                <Button id="btnLanjut" typeof='submit' aria-label='Tombol lanjut'>
                  Lanjut
                </Button>
              </div>
            </form>
